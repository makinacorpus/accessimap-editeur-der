...
angular.module('accessimapEditeurDerApp').run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put('scripts/routes/edit/aside_drawing_feature_properties.html', '<label>Propriétés de l\'objet {{$ctrl.featureProperties[\'data-type\']}}</label><table class="table table-hover"><thead><tr><th>Propriété</th><th>Valeur</th></tr></thead><tbody><tr ng-repeat="property in $ctrl.properties | filter:$ctrl.filterProperty"><td>{{property.name}}</td><td><input type="text" class="form-control" ng-model="$ctrl.featureProperties[property.name]" ng-if="! property.isStyle && ! property.isColor" ng-change="$ctrl.updateProperties()"></td></tr></tbody></table><label>Interactions</label><table class="table table-hover" ng-if="$ctrl.featureProperties.interactions"><thead><tr><th>Filtres</th><th>Valeur</th></tr></thead><tbody><tr ng-repeat="filter in $ctrl.interactions.getFilters()"><td>{{filter.name}}</td><td><input type="text" class="form-control" ng-model="$ctrl.featureProperties.interactions.filters[filter.id]" ng-if="filter.protocol===\'tts\'" style="width:100%"> <input type="file" class="form-control" ng-model="$ctrl.featureProperties.interactions.filters[filter.id]" ng-if="filter.protocol===\'mp3\'" style="width:100%"></td></tr></tbody></table><button class="btn btn-primary btn-block" ng-if="!$ctrl.featureProperties.interactions" ng-click="$ctrl.addInteraction()">Activer</button> <button class="btn btn-warning btn-block" ng-if="$ctrl.featureProperties.interactions" ng-click="$ctrl.removeInteraction()">Désactiver</button>');

  $templateCache.put('scripts/routes/edit/aside_drawing_parameters.html', '<h3><span class="fa fa-pencil" aria-hidden="true"></span> Dessin</h3><div class="col-xs-12"><div class="form-group btn-group"><label>Edition</label><br><button ng-click="$ctrl.enableDrawingMode(\'select\')" ng-class="{ \'active\' : $ctrl.mode === \'select\' }" class="btn btn-default" aria-label="Editer" title="Editer"><span class="fa fa-mouse-pointer" aria-hidden="true"></span></button></div><div class="form-group btn-group"><label>Formes géométriques</label><br><button ng-click="$ctrl.enableDrawingMode(\'point\')" ng-class="{ \'active\' : $ctrl.mode === \'point\' }" class="btn btn-default" aria-label="Point" title="Point"><img src="assets/icons/draw_point.png" width="20px" height="20px"></button> <button ng-click="$ctrl.enableDrawingMode(\'line\')" ng-class="{ \'active\' : $ctrl.mode === \'line\' }" class="btn btn-default" aria-label="Ligne (clic droit pour finir)" title="Ligne (clic droit pour finir)"><img src="assets/icons/draw_polygon.png" width="20px" height="20px"></button> <button ng-click="$ctrl.enableDrawingMode(\'circle\')" ng-class="{ \'active\' : $ctrl.mode === \'circle\' }" class="btn btn-default" aria-label="Ellipse / Cercle" title="Ellipse / Cercle"><img src="assets/icons/draw_ellipse.png" width="20px" height="20px"></button> <button ng-click="$ctrl.enableDrawingMode(\'triangle\')" ng-class="{ \'active\' : $ctrl.mode === \'triangle\' }" class="btn btn-default" aria-label="Triangle" title="Triangle"><img src="assets/icons/draw_triangle.png" width="20px" height="20px"></button> <button ng-click="$ctrl.enableDrawingMode(\'square\')" ng-class="{ \'active\' : $ctrl.mode === \'square\' }" class="btn btn-default" aria-label="Rectangle / Carré" title="Rectangle / Carré"><img src="assets/icons/draw_rectangle.png" width="20px" height="20px"></button> <button ng-click="$ctrl.enableDrawingMode(\'polygon\')" ng-class="{ \'active\' : $ctrl.mode === \'polygon\' }" class="btn btn-default" aria-label="Polygone (clic droit pour finir)" title="Polygone (clic droit pour finir)"><img src="assets/icons/draw_polygon_45.png" width="20px" height="20px"></button></div><div class="form-group btn-group"><label>Autre</label><br><button ng-click="$ctrl.enableDrawingMode(\'addtext\')" ng-class="{ \'active\' : $ctrl.mode === \'addtext\' }" class="btn btn-default" aria-label="Zone de texte" title="Zone de texte"><img src="assets/icons/draw_text.png" width="20px" height="20px"></button> <button ng-click="$ctrl.enableDrawingMode(\'image\')" ng-class="{ \'active\' : $ctrl.mode === \'image\' }" class="btn btn-default" aria-label="Importer une image" title="Importer une image"><img src="assets/icons/image.png" width="20px" height="20px"></button></div><div class="form-group" ng-if="!$ctrl.featureProperties" ng-include="\'scripts/routes/edit/aside_drawing_properties.html\'"></div><div class="form-group" ng-if="$ctrl.featureProperties" ng-include="\'scripts/routes/edit/aside_drawing_feature_properties.html\'"></div></div>');
  ...
  $templateCache.put('scripts/routes/edit/aside_interaction_parameters.html', '<h3><span class="fa fa-hand-pointer-o" aria-hidden="true"></span> Interaction</h3><div class="col-xs-12"><form><h4><span class="fa fa-filter" aria-hidden="true"></span> Types d\'interactions (filtres)</h4><uib-accordion close-others="false"><uib-accordion-group heading="{{filter.name}}" ng-repeat="filter in $ctrl.interactions.getFilters() track by filter.id"><table class="table table-hover"><tbody><tr><th>Nom</th><td><input type="text" ng-model="filter.name" class="form-control"></td></tr><tr><th>Type</th><td><select ng-model="filter.gesture" class="form-control"><option value="tap">tap</option><option value="double_tap">double_tap</option></select></td></tr><tr><th>Son <span class="fa fa-question-circle" tooltip-placement="right" uib-tooltip="Protocole TTS (Talk to Speech) : texte lu par la voix du système ou MP3 : choix d\'un fichier sonore"></span></th><td><select ng-model="filter.protocol" class="form-control"><option>TTS</option><option>MP3</option></select></td></tr></tbody></table><button class="btn btn-danger btn-block" ng-click="$ctrl.interactions.removeFilter(filter.id)">Supprimer filtre</button><table class="table table-hover" ng-if="$ctrl.interactions.getInteractions().length > 0"><thead><tr><th>Point</th><th>Valeur</th></tr></thead><tbody><tr ng-repeat="interaction in $ctrl.interactions.getInteractions()"><td>{{interaction.id}}</td><td><input type="text" ng-model="interaction.filters[filter.id]" ng-if="filter.protocol===\'tts\'" style="width:100%"> <input type="file" ng-model="interaction.filters[filter.id]" ng-if="filter.protocol===\'mp3\'" style="width:100%"></td></tr></tbody></table></uib-accordion-group><uib-accordion-group panel-class="panel-primary"><uib-accordion-heading>Créer un nouveau filtre</uib-accordion-heading><table class="table table-hover"><tbody><tr><th>Nom</th><td><input type="text" class="form-control" ng-model="name"></td></tr><tr><th>Type</th><td><select ng-model="gesture" class="form-control"><option value="tap">tap</option><option value="double_tap">double_tap</option></select></td></tr><tr><th>Son <span class="fa fa-question-circle" tooltip-placement="right" uib-tooltip="Protocole TTS (Talk to Speech) : texte lu par la voix du système ou MP3 : choix d\'un fichier sonore"></span></th><td><select ng-model="protocol" class="form-control"><option>TTS</option><option>MP3</option></select></td></tr></tbody></table><button class="btn btn-primary btn-block" ng-click="$ctrl.interactions.addFilter(name, gesture, protocol); name = \'\'; gesture = undefined; protocol = undefined;"><span class="fa fa-plus"></span> Créer filtre</button></uib-accordion-group></uib-accordion><h4><span class="fa fa-dot-circle-o" aria-hidden="true"></span> Liste des interactions</h4><div ng-if="$ctrl.interactions.getInteractions().length === 0"><p>Pas encore d\'interaction définie !</p></div><uib-accordion close-others="false" ng-if="$ctrl.interactions.getInteractions().length > 0"><uib-accordion-group is-open="$ctrl.featureProperties.interactions.id === interaction.id" heading="{{interaction.id}}" ng-repeat="interaction in $ctrl.interactions.getInteractions() track by interaction.id"><table class="table table-hover"><thead><tr><th>Filtres</th><th>Valeur</th></tr></thead><tbody><tr ng-repeat="filter in $ctrl.interactions.getFilters()"><td>{{filter.name}}</td><td><input type="text" class="form-control" ng-model="interaction.filters[filter.id]" ng-if="filter.protocol===\'tts\'" style="width:100%"> <input type="file" class="form-control" ng-model="interaction.filters[filter.id]" ng-if="filter.protocol===\'mp3\'" style="width:100%"></td></tr></tbody></table><button class="btn btn-warning btn-block" ng-click="$ctrl.removeInteraction()">Désactiver</button></uib-accordion-group></uib-accordion><button ng-if="$ctrl.currentFeature" class="btn btn-primary btn-block" ng-click="$ctrl.addInteraction()"><span class="fa fa-plus ng-scope" aria-hidden="true"></span> Ajouter une interaction</button><p ng-if="!$ctrl.currentFeature">Vous devez d\'abord sélectionner un élément pour ajouter une interaction.</p></form></div>');

  $templateCache.put('scripts/routes/edit/aside_legend_parameters.html', '<h3><span class="fa fa-braille" aria-hidden="true"></span> Légende</h3><div class="col-xs-12"><form><div class="toggle-group"><label for="cb1" class="toggle-label">Afficher en braille</label> <input class="tgl tgl-light" id="cb1" type="checkbox" ng-click="$ctrl.toggleFontBraille()" checked> <label class="tgl-btn" for="cb1"></label></div><hr><div class="form-group"><label>Format de la légende</label><select ng-model="$ctrl.model.legendFormat" ng-change="$ctrl.changeLegendFormat($ctrl.model.legendFormat)" class="form-control" ng-options="format as data.name for (format, data) in $ctrl.formats"></select></div></form></div>');

  $templateCache.put('scripts/routes/edit/aside_map_address.html', '<form><div class="input-group"><span class="input-group-addon"><span class="fa fa-lg fa-map-marker" aria-hidden="true"></span></span> <input ng-model="$ctrl.address.start" type="text" class="form-control" id="startAddress" placeholder="Adresse de départ (ex : 37 rue Monplaisir, Toulouse)"> <input ng-model="$ctrl.address.stop" type="text" class="form-control" id="stopAddress" placeholder="Adresse d\'arrivée"></div><button class="btn-input-group btn btn-primary btn-block" ng-click="$ctrl.searchAddress()"><span class="fa fa-map-marker" aria-hidden="true"></span> Positionner</button></form>');
  ...
  $templateCache.put('scripts/routes/edit/aside_menu.html', '<header class="editor-header"><a ng-href="#/" class="logo"><img src="assets/images/logos/logo.svg"> <span class="title">Éditeur</span></a><div class="der-title"><input type="text" ng-model="$ctrl.model.title" class="form-control input-lg"></div><div class="state-buttons"><div class="form-group"><button class="btn btn-default" ng-click="$ctrl.undo()" ng-disabled="!$root.isUndoable" aria-label="Annuler la dernière action" title="Annuler la dernière action (Ctrl+Z)"><span class="fa fa-lg fa-undo" aria-hidden="true"></span> Annuler</button> <button class="btn btn-default" ng-click="$ctrl.redo()" ng-disabled="!$root.isRedoable" aria-label="Annuler la dernière action" title="Annuler la dernière action (Ctrl+Y)"><span class="fa fa-lg fa-repeat" aria-hidden="true"></span> Restaurer</button></div></div></header><div class="aside-menu" ng-class="{\'expand\': $ctrl.expandedMenu}"><div class="main-menu btn-group-vertical"><button class="btn btn-info" ng-class="{\'active\': $ctrl.panel === \'draw\'}" ng-click="$ctrl.displayDrawingParameters()" tooltip-placement="right" uib-tooltip="Dessin"><span class="fa fa-lg fa-pencil" aria-hidden="true"></span> <span class="text">Dessin</span></button> <button class="btn btn-info" ng-class="{\'active\': $ctrl.panel === \'map\'}" ng-click="$ctrl.displayMapParameters();" tooltip-placement="right" uib-tooltip="Carte"><span class="fa fa-lg fa-map-o" aria-hidden="true"></span> <span class="text">Carte</span></button> <button class="btn btn-info" ng-class="{\'active\': $ctrl.panel === \'interaction\'}" ng-click="$ctrl.displayInteractionParameters()" tooltip-placement="right" uib-tooltip="Interaction"><span class="fa fa-lg fa-hand-pointer-o" aria-hidden="true"></span> <span class="text">Interaction</span></button> <button class="btn btn-info" ng-class="{\'active\': $ctrl.panel === \'legend\'}" ng-click="$ctrl.displayLegendParameters()" tooltip-placement="right" uib-tooltip="Légende"><span class="fa fa-lg fa-braille" aria-hidden="true"></span> <span class="text">Légende</span></button> <button class="btn btn-info" ng-class="{\'active\': $ctrl.panel === \'parameters\'}" ng-click="$ctrl.displayParameters()" aria-label="Paramètres" tooltip-placement="right" uib-tooltip="Paramètres"><span class="fa fa-lg fa-wrench" aria-hidden="true"></span> <span class="text">Paramètres</span></button></div><div class="export-menu btn-group-vertical"><button class="btn btn-success" ng-click="$ctrl.reset()" aria-label="Créer un nouveau DER" tooltip-placement="right" uib-tooltip="Créer un nouveau DER"><span class="fa fa-lg fa-file-o" aria-hidden="true"></span> <span class="text">Nouveau</span></button><file-field class="btn btn-default" aria-label="Importer un DERi (SVG, ZIP)" ng-model="uploadFile" onchange="angular.element(this).scope().$ctrl.importDER(this.childNodes[1])" accept="image/svg+xml,application/zip" tooltip-placement="right" uib-tooltip="Importer un DERi (SVG, ZIP)"><span class="fa fa-lg fa-download" aria-hidden="true"></span> <span class="text">Importer</span></file-field><button class="btn btn-default" ng-click="$ctrl.exportData()" aria-label="Exporter le DERi" tooltip-placement="right" uib-tooltip="Exporter le DERi"><span class="fa fa-lg fa-upload" aria-hidden="true"></span> <span class="text">Exporter</span></button> <button class="btn btn-info" ng-click="$ctrl.expandMenu()" aria-label="Détails du menu" tooltip-placement="right" uib-tooltip="Détails du menu"><span class="fa fa-lg fa-arrow-right" ng-class="{\'left\': $ctrl.expandedMenu}" aria-hidden="true"></span> <span class="text">Expand</span></button></div></div>');
