...
angular.module('accessimapEditeurDerApp').run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put('scripts/routes/edit/aside_drawing_feature_properties.html', '<h4 class="col-xs-12">Propriétés de l\'objet {{$ctrl.featureProperties[\'data-type\']}}</h4><div class="col-xs-12"><table class="table table-hover"><thead><tr><th>Propriété</th><th>Valeur</th></tr></thead><tbody><tr ng-repeat="property in $ctrl.properties | filter:$ctrl.filterProperty"><td>{{property.name}}</td><td><input type="text" class="form-control" ng-model="$ctrl.featureProperties[property.name]" ng-if="! property.isStyle && ! property.isColor" ng-change="$ctrl.updateProperties()"></td></tr></tbody></table></div><div class="col-xs-12"><button ng-click="$ctrl.goToInteraction()" class="btn btn-primary btn-block">Accéder aux interaction de l\'objet</button></div>');

  $templateCache.put('scripts/routes/edit/aside_drawing_parameters.html', '<h3>Dessin</h3><h4 class="col-xs-12">Edition</h4><div class="col-xs-12"><div class="form-group btn-group"><button ng-click="$ctrl.enableDrawingMode(\'select\')" ng-class="{ \'active\' : $ctrl.mode === \'select\' }" class="btn btn-default" aria-label="Editer" title="Editer"><span class="fa fa-mouse-pointer" aria-hidden="true"></span></button></div></div><h4 class="col-xs-12">Formes géométriques</h4><div class="col-xs-12"><div class="form-group btn-group"><button ng-click="$ctrl.enableDrawingMode(\'point\')" ng-class="{ \'active\' : $ctrl.mode === \'point\' }" class="btn btn-default" aria-label="Point" title="Point"><img src="assets/icons/draw_point.png" width="20px" height="20px"></button> <button ng-click="$ctrl.enableDrawingMode(\'line\')" ng-class="{ \'active\' : $ctrl.mode === \'line\' }" class="btn btn-default" aria-label="Ligne (clic droit pour finir)" title="Ligne (clic droit pour finir)"><img src="assets/icons/draw_polygon.png" width="20px" height="20px"></button> <button ng-click="$ctrl.enableDrawingMode(\'circle\')" ng-class="{ \'active\' : $ctrl.mode === \'circle\' }" class="btn btn-default" aria-label="Ellipse / Cercle" title="Ellipse / Cercle"><img src="assets/icons/draw_ellipse.png" width="20px" height="20px"></button> <button ng-click="$ctrl.enableDrawingMode(\'triangle\')" ng-class="{ \'active\' : $ctrl.mode === \'triangle\' }" class="btn btn-default" aria-label="Triangle" title="Triangle"><img src="assets/icons/draw_triangle.png" width="20px" height="20px"></button> <button ng-click="$ctrl.enableDrawingMode(\'square\')" ng-class="{ \'active\' : $ctrl.mode === \'square\' }" class="btn btn-default" aria-label="Rectangle / Carré" title="Rectangle / Carré"><img src="assets/icons/draw_rectangle.png" width="20px" height="20px"></button> <button ng-click="$ctrl.enableDrawingMode(\'polygon\')" ng-class="{ \'active\' : $ctrl.mode === \'polygon\' }" class="btn btn-default" aria-label="Polygone (clic droit pour finir)" title="Polygone (clic droit pour finir)"><img src="assets/icons/draw_polygon_45.png" width="20px" height="20px"></button></div></div><h4 class="col-xs-12">Autres</h4><div class="col-xs-12"><div class="form-group btn-group"><button ng-click="$ctrl.enableDrawingMode(\'addtext\')" ng-class="{ \'active\' : $ctrl.mode === \'addtext\' }" class="btn btn-default" aria-label="Zone de texte" title="Zone de texte"><img src="assets/icons/draw_text.png" width="20px" height="20px"></button> <button ng-click="$ctrl.enableDrawingMode(\'image\')" ng-class="{ \'active\' : $ctrl.mode === \'image\' }" class="btn btn-default" aria-label="Importer une image" title="Importer une image"><img src="assets/icons/image.png" width="20px" height="20px"></button></div><div class="form-group" ng-if="!$ctrl.featureProperties" ng-include="\'scripts/routes/edit/aside_drawing_properties.html\'"></div></div><div class="form-group" ng-if="$ctrl.featureProperties" ng-include="\'scripts/routes/edit/aside_drawing_feature_properties.html\'"></div>');

  $templateCache.put('scripts/routes/edit/aside_drawing_properties.html', '<form><p ng-if="$ctrl.mode === \'select\' || $ctrl.mode === \'\'">Choisissez un outil de dessin pour paramétrer le style, la couleur, ...</p><div class="form-group" ng-if="$ctrl.mode !== \'select\' && $ctrl.mode !== \'\' && $ctrl.mode !== \'text\' && $ctrl.mode !== \'image\'"><label>Style</label><ui-select ng-model="$ctrl.styleChosen" ng-change="$ctrl.updatePolygonStyle()" ng-disabled="disabled" theme="bootstrap" class="form-control style-selector"><ui-select-match placeholder="Sélectionnez un style">{{$select.selected.name}}</ui-select-match><ui-select-choices repeat="item in $ctrl.styleChoices | filter: $select.search" style="max-height: 500px;"><div class="opt-style-container"><span style="display:inline-block;" ng-bind-html="item.name | highlight: $select.search"></span> <span ng-class="{\'opt-style-visu arrow-trick\': item.id.indexOf(\'Arrow\') > -1, \'opt-style-visu \': item.id.indexOf(\'Arrow\') === -1}" style="max-height:30px;display:inline-block;" ng-bind-html="$ctrl.featureIcon(item, $ctrl.mode)"></span></div></ui-select-choices></ui-select></div><div class="form-group" ng-if="$ctrl.mode === \'polygon\' || $ctrl.mode === \'circle\'"><div class="toggle-group form-group"><label for="border" class="toggle-label">Contour de forme</label> <input class="tgl tgl-light" id="border" type="checkbox" ng-model="$ctrl.checkboxModel.contour" ng-change="$ctrl.updatePolygonStyle()"> <label class="tgl-btn" for="border"></label></div></div><div class="form-group" ng-if="$ctrl.mode === \'polygon\' || $ctrl.mode === \'circle\' || $ctrl.mode === \'triangle\' || $ctrl.mode === \'square\'"><label>Couleur de fond</label><ui-select ng-model="$ctrl.colorChosen" ng-change="$ctrl.changeColor()" ng-disabled="disabled" theme="bootstrap" class="form-control style-selector"><ui-select-match placeholder="Couleur de fond">{{$select.selected.name}}</ui-select-match><ui-select-choices repeat="item in $ctrl.colors | filter: $select.search" style="max-height: 500px;"><span style="display:inline-block;" ng-bind-html="item.name | highlight: $select.search"></span></ui-select-choices></ui-select></div><div class="form-group" ng-if="$ctrl.mode === \'addtext\'"><label>Police</label><ui-select ng-model="$ctrl.fontChosen" ng-change="$ctrl.changeTextColor()" theme="bootstrap" class="form-control style-selector"><ui-select-match placeholder="Sélectionnez une police">{{$select.selected.name}}</ui-select-match><ui-select-choices repeat="item in $ctrl.fonts | filter: $select.search"><div ng-bind-html="item.name | highlight: $select.search"></div></ui-select-choices></ui-select></div><div class="form-group" ng-if="$ctrl.mode === \'addtext\'"><label>Couleur</label><ui-select ng-model="$ctrl.fontColorChosen" theme="bootstrap" class="form-control style-selector"><ui-select-match placeholder="Sélectionnez une couleur">{{$select.selected.name}}</ui-select-match><ui-select-choices repeat="item in $ctrl.fontColors[$ctrl.fontChosen.color] | filter: $select.search"><div ng-bind-html="item.name | highlight: $select.search"></div></ui-select-choices></ui-select></div><div class="form-group" ng-if="$ctrl.mode === \'image\'"><label>Importer une image (SVG/JPG/PNG)</label><input onchange="angular.element(this).scope().$ctrl.importImage(this)" type="file" accept="image/svg+xml,image/png,image/jpeg"></div></form>');

  $templateCache.put('scripts/routes/edit/aside_interaction_parameters.html', '<h3>Interaction</h3><h4 class="col-xs-12">Filtres</h4><div class="list-filters"><form action class="form-inline"><div class="form-group" ng-repeat="filter in $ctrl.interactions.getFilters()"><input type="text" ng-model="filter.name" class="form-control"> <button class="btn btn-sm remove-button" ng-click="$ctrl.interactions.removeFilter(filter.id)"><i class="material-icons">close</i></button></div><button class="btn btn-sm btn-default pull-right" ng-click="$ctrl.interactions.addFilter(name); name = \'\';"><i class="material-icons mat-btn">add</i> Nouveau filtre</button></form></div><h4 class="col-xs-12">Liste des éléments</h4><div class="col-xs-12" ng-show="$ctrl.interactions.getInteractions().length === 0"><p>Pas encore d\'interaction définie !</p></div>&nbsp;<div class="list-interaction-container"><form><uib-accordion close-others="true" ng-show="$ctrl.showInteractions"><uib-accordion-group is-open="$ctrl.interactionOpen[poi.id]" ng-repeat="poi in $ctrl.interactions.getInteractions()"><uib-accordion-heading><span class="label" ng-class="{\'active\': poi.id === \'poi-\' + $ctrl.currentPoi}"></span> {{poi.id}} {{$ctrl.interactionIsOpen(poi.id)}}</uib-accordion-heading><uib-accordion close-others="false"><uib-accordion-group ng-repeat="filter in $ctrl.interactions.getFilters()" class="list-interactions"><uib-accordion-heading>Filtre : {{filter.name}} <small>({{$ctrl.getInteractionsByFilterLength(poi.interactions, filter.id)}} interactions)</small></uib-accordion-heading><div class="list-interactions-item" ng-repeat="interaction in poi.interactions | filter: filter.id"><button tooltip-placement="left" uib-tooltip="Supprimer l\'interaction" class="btn btn-sm btn-default remove-interaction" ng-click="$ctrl.removeInteraction(poi.id, $index)"><i class="material-icons">delete</i></button><div class="col-sm-6 form-group" ng-class="{\'has-error\': poi.hasError && poi.filterError === interaction.filter}"><label class="control-label" for="gesture">Déclencheur</label><select id="gesture" ng-model="interaction.gesture" class="form-control input-sm" ng-change="$ctrl.isInteractionHasError(poi)"><option value="tap">tap</option><option value="double_tap">double_tap</option></select></div><div class="col-sm-6 form-group"><label class="control-label" for="protocol">Nature du son</label><select id="protocol" ng-model="interaction.protocol" class="form-control input-sm"><option>tts</option><option>mp3</option></select></div><div class="col-sm-12 form-group"><input id="valuetts" type="text" class="form-control input-sm" placeholder="Valeur (ce qui sera lu)" ng-model="interaction.value" ng-if="interaction.protocol===\'tts\'" style="width:100%"> <input id="valuemp3" type="file" class="form-control input-sm" placeholder="Valeur (le son qui sera joué)" ng-model="interaction.value" ng-if="interaction.protocol===\'mp3\'" style="width:100%"></div></div><div class="list-interactions-footer"><div class="has-error" ng-if="poi.hasError && poi.filterError === filter.id"><span class="help-block">Attention : il ne peut y avoir qu\'une seule interaction pour un même filtre et un même déclencheur sur un même élément.</span></div><button class="btn btn-sm btn-default pull-right" ng-click="$ctrl.addInteraction(poi.id, filter.id)"><i class="material-icons mat-btn">add</i> Nouvelle interaction</button></div></uib-accordion-group></uib-accordion></uib-accordion-group></uib-accordion></form></div><p class="col-xs-12" ng-if="!$ctrl.currentFeature">Veuillez sélectionner un élément pour y ajouter une interaction.</p>');

  $templateCache.put('scripts/routes/edit/aside_legend_parameters.html', '<h3>Légende</h3><div class="col-xs-12"><form><div class="toggle-group"><label for="cb1" class="toggle-label">Afficher en braille</label> <input class="tgl tgl-light" id="cb1" type="checkbox" ng-click="$ctrl.toggleFontBraille()" checked> <label class="tgl-btn" for="cb1"></label></div><hr><div class="form-group"><label>Format de la légende</label><select ng-model="$ctrl.model.legendFormat" ng-change="$ctrl.changeLegendFormat($ctrl.model.legendFormat)" class="form-control" ng-options="format as data.name for (format, data) in $ctrl.formats"></select></div></form></div>');

  $templateCache.put('scripts/routes/edit/aside_map_address.html', '<form><div class="input-group"><input ng-model="$ctrl.address.start" type="text" class="form-control" id="startAddress" placeholder="Adresse de départ (ex : 37 rue Monplaisir, Toulouse)"> <input ng-model="$ctrl.address.stop" type="text" class="form-control" id="stopAddress" placeholder="Adresse d\'arrivée"></div><button class="btn-input-group btn btn-primary btn-block" ng-click="$ctrl.searchAddress()"><i class="material-icons mat-btn">place</i> Positionner</button></form>');

  $templateCache.put('scripts/routes/edit/aside_map_feature_creation.html', '<form><div class="form-group"><label>Type de POI</label><ui-select ng-model="$ctrl.queryChosen" ng-disabled="$ctrl.disabled" theme="bootstrap" ng-change="$ctrl.changeStyle()" class="form-control style-selector"><ui-select-match placeholder="Sélectionnez un élément">{{$select.selected.name}}</ui-select-match><ui-select-choices repeat="item in $ctrl.queryChoices | filter: $select.search | layerNotSelected:this.geojson | orderBy:[\'icon\',\'type\']"><i class="icon-15px fa fa-{{item.icon}}"></i> <i ng-if="item.type === \'point\'" class="icon-15px fa fa-map-marker"></i> <i ng-if="item.type === \'line\'" class="icon-15px fa fa-minus"></i> <i ng-if="item.type === \'polygon\'" class="icon-15px fa fa-square-o"></i> <span ng-bind-html="item.name | highlight: $select.search"></span></ui-select-choices></ui-select></div><div class="form-group"><label>Style</label><ui-select ng-model="$ctrl.styleChosen" ng-disabled="$ctrl.disabled" theme="bootstrap" class="form-control style-selector"><ui-select-match placeholder="Sélectionnez un style">{{$select.selected.name}}</ui-select-match><ui-select-choices repeat="item in $ctrl.styleChoices | filter: $select.search" style="max-height: 500px;"><span style="display:inline-block;" ng-bind-html="item.name | highlight: $select.search"></span> <span style="max-height:30px;display:inline-block;" ng-bind-html="$ctrl.featureIcon(item, $ctrl.queryChosen.type)"></span></ui-select-choices></ui-select></div><div class="form-group" ng-if="$ctrl.queryChosen.type === \'polygon\'"><label>Couleur</label><ui-select ng-model="$ctrl.colorChosen" ng-disabled="$ctrl.disabled" theme="bootstrap" class="form-control style-selector"><ui-select-match placeholder="Couleur de fond">{{$select.selected.name}}</ui-select-match><ui-select-choices repeat="item in $ctrl.colors | filter: $select.search" style="max-height: 500px;"><span style="display:inline-block;" ng-bind-html="item.name | highlight: $select.search"></span></ui-select-choices></ui-select></div><div class="form-group" ng-if="$ctrl.queryChosen.type === \'polygon\'"><div class="toggle-group form-group"><label for="border" class="toggle-label">Contour de forme</label> <input class="tgl tgl-light" id="border" type="checkbox" ng-model="$ctrl.checkboxModel.contour"> <label class="tgl-btn" for="border"></label></div></div><button ng-if="$ctrl.queryChosen.id !== \'poi\'" class="btn btn-primary btn-block" ng-click="$ctrl.insertOSMData()" type="button"><span class="fa fa-cloud-download" aria-hidden="true"></span> Insérer les données cartographiques</button></form>');

  $templateCache.put('scripts/routes/edit/aside_map_feature_management.html', '<p ng-if="!$ctrl.getFeatures() || $ctrl.getFeatures().length === 0">Pas encore d\'éléments !<br>Vous verrez ici les éléments que vous allez créer via les boutons d\'ajouts de POI, d\'adresse ou de données OSM !</p><uib-accordion close-others="true" ng-if="$ctrl.getFeatures() && $ctrl.getFeatures().length > 0"><uib-accordion-group heading="{{feature.name}}" is-open="status.isFirstOpen" is-disabled="status.isFirstDisabled" ng-repeat="feature in $ctrl.getFeatures()"><div class="form-group"><label>Style</label><ui-select ng-model="feature.style" ng-disabled="$ctrl.disabled" ng-change="$ctrl.updateFeature(feature.id, feature.style)" theme="bootstrap" cb1lass="form-control style-selector"><ui-select-match placeholder="Sélectionnez un style">{{$select.selected.name}}</ui-select-match><ui-select-choices repeat="item in feature.styleChoices | filter: $select.search" style="max-height: 500px;"><span style="display:inline-block;" ng-bind-html="item.name | highlight: $select.search"></span> <span style="max-height:30px;display:inline-block;" ng-bind-html="$ctrl.featureIcon(item, feature.type)"></span></ui-select-choices></ui-select></div><div class="form-group" ng-if="feature.type === \'point\'"><label>Rotation</label><div class="input-group"><span class="input-group-addon"><span class="fa fa-repeat" aria-hidden="true"></span></span><slider class="form-control slider-container" ng-model="feature.rotation" ng-change="$ctrl.rotateFeature(feature)" min="0" max="360"></slider></div></div><div class="form-group" ng-if="feature.type === \'polygon\'"><label>Couleur</label><ui-select ng-model="feature.color" ng-change="$ctrl.updateFeature(feature.id, feature.style)" ng-disabled="$ctrl.disabled" theme="bootstrap" class="form-control style-selector"><ui-select-match placeholder="Couleur de fond">{{$select.selected.name}}</ui-select-match><ui-select-choices repeat="item in $ctrl.colors | filter: $select.search" style="max-height: 500px;"><span style="display:inline-block;" ng-bind-html="item.name | highlight: $select.search"></span></ui-select-choices></ui-select></div><div class="form-group" ng-if="feature.type === \'polygon\'"><div class="toggle-group form-group"><label for="border" class="toggle-label">Contour de forme</label> <input class="tgl tgl-light" id="border" type="checkbox" ng-model="feature.contour" ng-change="$ctrl.updateFeature(feature.id, feature.style)"> <label class="tgl-btn" for="border"></label></div></div><button class="btn btn-danger btn-block" type="button" ng-click="$ctrl.removeFeature(feature.id)"><span class="glyphicon glyphicon-remove-circle" aria-hidden="true"></span> Supprimer</button></uib-accordion-group></uib-accordion>');

  $templateCache.put('scripts/routes/edit/aside_map_parameters.html', '<h3>Carte</h3><div class="col-xs-12"><div class="toggle-group"><label for="show-map" class="toggle-label">Afficher la carte</label> <input class="tgl tgl-light" id="show-map" type="checkbox" ng-click="$ctrl.toggleMap()" checked> <label class="tgl-btn" for="show-map"></label></div><hr><uib-accordion close-others="true"><uib-accordion-group><uib-accordion-heading><span class="fa fa-list" aria-hidden="true"></span> Liste des éléments</uib-accordion-heading><div ng-include="\'scripts/routes/edit/aside_map_feature_management.html\'"></div></uib-accordion-group><uib-accordion-group ng-click="$ctrl.displayAddPOIForm()"><uib-accordion-heading><span class="fa fa-dot-circle-o" aria-hidden="true"></span> Ajouter un POI</uib-accordion-heading><div ng-include="\'scripts/routes/edit/aside_map_poi_creation.html\'"></div></uib-accordion-group><uib-accordion-group><uib-accordion-heading><span class="fa fa-search" aria-hidden="true"></span> Chercher une adresse</uib-accordion-heading><div ng-include="\'scripts/routes/edit/aside_map_address.html\'"></div></uib-accordion-group><uib-accordion-group ng-click="$ctrl.initOSMMode()"><uib-accordion-heading><span class="fa fa-cloud-download" aria-hidden="true"></span> Obtenir des données d\'OSM</uib-accordion-heading><div ng-include="\'scripts/routes/edit/aside_map_feature_creation.html\'"></div></uib-accordion-group></uib-accordion></div>');

  $templateCache.put('scripts/routes/edit/aside_map_poi_creation.html', '<form><div class="form-group"><label>Style</label><ui-select ng-model="$ctrl.styleChosenPoi" ng-disabled="$ctrl.disabled" theme="bootstrap" class="form-control style-selector"><ui-select-match placeholder="Sélectionnez un style">{{$select.selected.name}}</ui-select-match><ui-select-choices repeat="item in $ctrl.styleChoicesPoi | filter: $select.search" style="max-height: 500px;"><div class="opt-style-container"><span style="display:inline-block;" ng-bind-html="item.name | highlight: $select.search"></span> <span ng-class="{\'opt-style-visu arrow-trick\': item.id.indexOf(\'Arrow\') > -1, \'opt-style-visu \': item.id.indexOf(\'Arrow\') === -1}" style="max-height:30px" ng-bind-html="$ctrl.featureIcon(item, $ctrl.queryChosenPoi.type)"></span></div></ui-select-choices></ui-select></div></form>');

  $templateCache.put('scripts/routes/edit/aside_menu.html', '<header class="editor-header"><a ng-href="#/" class="logo"><img src="assets/images/logos/logo.svg"> <span class="title">Éditeur</span></a><div class="der-title"><input type="text" ng-model="$ctrl.model.title" class="form-control input-lg"></div><div class="state-buttons"><div class="form-group"><button class="btn btn-default" ng-click="$ctrl.undo()" ng-disabled="!$root.isUndoable" aria-label="Annuler la dernière action" title="Annuler la dernière action (Ctrl+Z)"><i class="material-icons mat-btn">undo</i> Annuler</button> <button class="btn btn-default" ng-click="$ctrl.redo()" ng-disabled="!$root.isRedoable" aria-label="Annuler la dernière action" title="Annuler la dernière action (Ctrl+Y)"><i class="material-icons mat-btn">redo</i> Restaurer</button></div></div></header><div class="aside-menu" ng-class="{\'expand\': $ctrl.expandedMenu}"><div class="main-menu btn-group-vertical"><button class="btn btn-info" ng-class="{\'active\': $ctrl.panel === \'draw\'}" ng-click="$ctrl.displayDrawingParameters()" tooltip-placement="right" uib-tooltip="Dessin"><i class="material-icons">edit</i> <span class="text">Dessin</span></button> <button class="btn btn-info" ng-class="{\'active\': $ctrl.panel === \'map\'}" ng-click="$ctrl.displayMapParameters();" tooltip-placement="right" uib-tooltip="Carte"><i class="material-icons">map</i> <span class="text">Carte</span></button> <button class="btn btn-info" ng-class="{\'active\': $ctrl.panel === \'interaction\'}" ng-click="$ctrl.displayInteractionParameters()" tooltip-placement="right" uib-tooltip="Interaction"><i class="material-icons">touch_app</i> <span class="text">Interaction</span></button> <button class="btn btn-info" ng-class="{\'active\': $ctrl.panel === \'legend\'}" ng-click="$ctrl.displayLegendParameters()" tooltip-placement="right" uib-tooltip="Légende"><span class="fa fa-lg fa-braille" aria-hidden="true"></span> <span class="text">Légende</span></button> <button class="btn btn-info" ng-class="{\'active\': $ctrl.panel === \'parameters\'}" ng-click="$ctrl.displayParameters()" aria-label="Paramètres" tooltip-placement="right" uib-tooltip="Paramètres"><i class="material-icons">settings</i> <span class="text">Paramètres</span></button></div><div class="export-menu btn-group-vertical"><button class="btn btn-success" ng-click="$ctrl.reset()" aria-label="Créer un nouveau DER" tooltip-placement="right" uib-tooltip="Créer un nouveau DER"><span class="material-icons">insert_drive_file</span> <span class="text">Nouveau</span></button><file-field class="btn btn-default" aria-label="Importer un DERi (SVG, ZIP)" ng-model="uploadFile" onchange="angular.element(this).scope().$ctrl.importDER(this.childNodes[1])" accept="image/svg+xml,application/zip" tooltip-placement="right" uib-tooltip="Importer un DERi (SVG, ZIP)"><span class="material-icons">cloud_upload</span> <span class="text">Importer</span></file-field><button class="btn btn-default" ng-click="$ctrl.exportData()" aria-label="Exporter le DERi" tooltip-placement="right" uib-tooltip="Exporter le DERi"><span class="material-icons">cloud_download</span> <span class="text">Exporter</span></button> <button class="btn btn-info" ng-click="$ctrl.expandMenu()" aria-label="Détails du menu" tooltip-placement="right" uib-tooltip="Détails du menu"><span class="material-icons">arrow_forward</span> <span class="text">Expand</span></button></div></div>');

  $templateCache.put('scripts/routes/edit/aside_parameters.html', '<h3><span class="fa fa-wrench" aria-hidden="true"></span> Paramètres</h3><div class="col-xs-12"><form class="row"><div class="form-group col-xs-12"><label>Titre</label> <input type="text" ng-model="$ctrl.model.title" class="form-control"></div><div class="form-group col-xs-12"><label>Format du dessin</label><select ng-model="$ctrl.model.mapFormat" ng-change="$ctrl.changeDrawingFormat($ctrl.model.mapFormat)" class="form-control" ng-options="format as data.name for (format, data) in $ctrl.formats"></select></div><div class="form-group col-xs-12"><label>Commentaires de transcription</label> <textarea class="form-control" ng-model="$ctrl.model.comment" rows="10" style="resize:none" id="comment">\n            </textarea></div></form></div>');
  ...
  $templateCache.put('scripts/routes/edit/template.html', '<div ng-include="\'scripts/routes/edit/aside_menu.html\'"></div><aside class="right-side" ng-class="{\'panel\': $ctrl.panel !== null}"><div class="aside-content" ng-include="\'scripts/routes/edit/aside.html\'"></div></aside><main ng-init="$ctrl.init()"><div id="workspace" ng-show="$ctrl.panel !== \'legend\'"></div><div id="legend" ng-show="$ctrl.panel === \'legend\'"></div><div id="pattern"></div></main><div ng-include="\'scripts/routes/edit/modalchangecolor.html\'"></div><div ng-include="\'scripts/routes/edit/modalchangepattern.html\'"></div><div ng-include="\'scripts/routes/edit/modalchangearrows.html\'"></div><div ng-include="\'scripts/routes/edit/modalchangepoint.html\'"></div>');

  $templateCache.put('scripts/routes/home/template.html', '<div class="container jumbotron"><img src="assets/images/logos/logo.svg" class="logo"><h3>Ajoutez de l\'interaction à vos dessins en reliefs (DER)</h3><h3>Configurez et personnalisez facilement vos documents avant de les imprimer !</h3><br><form class="form-inline"><div class="form-group"><button type="button" class="btn btn-primary btn-lg btn-block" ng-click="$ctrl.goToEdit()">Créer un nouveau DER</button></div></form><h3>Partenaires</h3><br><table class="table--four-column"><tbody><tr><td><a href="http://www.ijatoulouse.org/"><img src="assets/images/logos/ija.jpg"></a></td><td><a href="https://www.irit.fr/"><img src="assets/images/logos/irit.jpg"></a></td><td><a href="http://www.telecom-paristech.fr/"><img src="assets/images/logos/telecom.png"></a></td><td><a href="http://makina-corpus.com/"><img src="assets/images/logos/makinacorpus.png"></a></td></tr></tbody></table><br><br><span class="material-icons mat-btn">warning</span>&nbsp; Si l\'affichage vous paraît trop gros, réglez le zoom de votre navigateur. (Ctrl + molette souris)<br><br><table class="table--five-column"><tr><td><a href="http://www.accessimap.com/">Projet Accessimap</a></td><td><a href="https://github.com/makinacorpus/accessimap-editeur-der/"><span class="fa fa-github fa-lg">&nbsp;</span> Sources GitHub</a></td><td><a href="docs/" target="_blank"><i class="material-icons mat-btn">book</i> Documentation</a></td><td><a href="mailto:contact@makina-corpus.com"><i class="material-icons mat-btn">email</i>&nbsp; Contact</a></td><td><a href="http://makinacorpus.github.io/accessimap-editeur-der/v1">Editeur v1</a></td></tr></table></div>');
