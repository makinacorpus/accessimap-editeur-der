...
angular.module('accessimapEditeurDerApp')
    .service('toolbox',
        ['generators', 'geometryutils', 'styleutils', 'radialMenu', 'settings', 'UtilService',
        function(generators, geometryutils, styleutils, radialMenu, settings, UtilService) {
            ...
            this.changeTextColor = function (model) {
                model.fontColorChosen =
                    model.fontColors[model.fontChosen.color][0];
            };

            this.updatePolygonStyle = function (model) {
            ...
            this.updateMarker = function (model) {
                var path = d3.select('.styleEdition');
